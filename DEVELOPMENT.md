...
```bash
git remote add encore encore://reprice-genius-platform-s3n2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/reprice-genius-platform-s3n2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/reprice-genius-platform-s3n2/settings/integrations/github)
